...
export default {
  ...
  created() {
    const cache = JSON.parse(sessionStorage.getItem('Match-Release-Filter-Params'))
  ...
  methods: {
    ...
    handleSubmit() {
      sessionStorage.setItem('Match-Release-Filter-Params', JSON.stringify(this.params))
      this.$router.go(-1)
    }
  }
}
