<template>
  <div class="recommend-item" @click="goDetail(item.articleId)">
      ...
      <div class="message" flex="dir:top">
        <div flex="cross:center">
          <div class="md name">
            ...
            <span
              v-if="item.twelve && item.twelveOfX"
              class="s_t s_t_blue"
            ><font>{{ item.twelve }}中{{ item.twelveOfX }}</font></span>
            <span
              v-if="item.linkwin"
              class="s_t s_t_red"
          ...
          <div class="sd number">
            {{ sortBy === "winrate" ? item.winrate : item.returnrate }}%
          </div>
        </div>
        <div flex="cross:center">
          <div class="md">
          ...
          <div class="sd">{{ sortBy === "winrate" ? "胜率" : "周返还率" }}</div>
        </div>
      </div>
    </div>
